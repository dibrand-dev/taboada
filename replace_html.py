...
<div class="w-full aspect-square bg-cover bg-center rounded-lg shadow-sm border border-outline-variant/30" data-alt="A serene, high-key, minimalist photograph of an abstract, elegant medical optical lens or prism reflecting soft natural light. The setting is bright and airy, utilizing a premium clinical aesthetic with a palette of pure whites, soft grays, and subtle deep blue hints. The mood is calm, authoritative, and sophisticated, avoiding any harsh hospital tones." style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuDLAZSUTSc8ASYdSeHr2TjOLBY4wFe6-ThuWT37gwWQIIeKQl2soNrmM6evDPgInxARshZ1IbO8M_Jg1c8f3wmMsfpWdEvjh0jZ6zAtZPIYV0vU4nFr-RSdkEBFmpl_qZEnDRJHk1NP6uHmDpxi4jB2m2GFqr9cOHe0rxUtUn3ihmdLoyEULMrMoR-pYUkk2iYEuFTxDok3kB40He3ClZ_yZlaEwWj8JqNt1PzJXasE05g97yH3O5PE')"></div>
</div>
</div>
</section>
<!-- Filter Section -->
