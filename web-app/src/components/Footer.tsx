      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-12">
          <div className="max-w-md">
            <h5 className="font-marcellus text-h2 mb-4">Dra. María Cecilia Taboada</h5>
            <p className="text-white/60 font-inter text-body-md leading-relaxed">
              Comprometidos con la salud visual de alta complejidad y el bienestar preventivo.
            </p>
          </div>
          <div className="flex flex-col md:flex-row gap-12 md:gap-24">
            <div className="space-y-4">
              <p className="text-label-caps text-secondary-fixed font-bold font-allround text-badge">Legales</p>
              <ul className="space-y-2 text-white/50 font-inter text-body-md">
            ...
            <div className="space-y-4">
              <p className="text-label-caps text-secondary-fixed font-bold font-allround text-badge">Conectamos</p>
