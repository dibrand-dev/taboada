          ...
          <div className="flex flex-col md:flex-row gap-12 md:gap-24">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-6">
                <a className="w-10 h-10 border border-white/20 rounded-full flex items-center justify-center hover:bg-white/10 transition-colors" href="https://www.instagram.com/draceciliataboada" target="_blank" rel="noopener noreferrer">
                ...
                <a className="w-10 h-10 border border-white/20 rounded-full flex items-center justify-center hover:bg-white/10 transition-colors" href="https://www.linkedin.com/in/dra-cecilia-taboada/" target="_blank" rel="noopener noreferrer">
